...
class AVNNConv2dBlock(Module):
    def __init__(self, in_channels, hidden_channels=None, out_channels=None, kernel_size=3, stride=1, padding=0, derive_mode=derived_adjustedmean, activation=relu):
        super().__init__()
